...
const AllContest = () => {
    ...
    const { data, isLoading, error } = useQuery({
        ...
        queryFn: async () => {
            ...
            const res = await axiosSecure.get(`/contest?type=${typeParam}&page=${currentPage}&limit=${itemsPerPage}`);
            return res.data;
        },
    ...
    const categories = ["All", "Design", "Games", "Development", "Art", "Writing", "Photography", "Videos"];
