                ...
                <form onSubmit={handleSubmit(handleContestForm)} className="bg-white p-6 rounded-xl shadow space-y-6">
                    ...
                    <div className="form-control flex flex-col gap-2">
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed rounded-lg cursor-pointer bg-base-100 hover:bg-base-200">
                            ...
                            <span className="text-sm font-medium opacity-80">Click to upload or drag and drop</span>
                            <span className="text-xs text-gray-500 mt-1">PNG, JPG or GIF (MAX. 800×400px)</span>
                    ...
                    <div className="form-control flex flex-col gap-1">
                        ...
                        ></textarea>
                        {errors.instruction && <p className="text-error text-xs mt-1">{errors.instruction.message}</p>}
                    </div>
