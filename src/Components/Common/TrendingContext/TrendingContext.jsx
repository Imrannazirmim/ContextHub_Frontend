          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {trending.map((contest) => (
                <div
                  key={contest._id}
                  className="group shadow rounded-2xl  hover:shadow-2xl transition-all duration-300 overflow-hidden"
                >
                  {/* Image */}
                  ...
                  <div className="p-6 card-body">
                    ...
                    <Link
                      ...
                      className=" w-full text-center btn btn-primary rounded-xl hover:btn-secondary transition"
                    >
                      View Details
                    </Link>
                  </div>
